...
class EmployeeControllerTest {
    ...
    void setUp() {
        ...
        listEmployeeBody = ListEmployeeBody.builder()
                .total(5)
                .employees(employeeList.stream().map(EmployeeBody::fromEntity).collect(Collectors
                        .toList()))
                .build();
    }
    ...
    void create_InvalidData_BadRequest() throws Exception {
        ...
        Mockito.doThrow(new InvalidDataException("Exception invalid data")).when(employeeService)
                .create(body);
