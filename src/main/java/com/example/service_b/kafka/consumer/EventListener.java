...
public class EventListener {
  ...
  public void partition_1(@Payload String message) {
    System.out.println("@D_LOG: topic 3 partition 1:" + message);
  }
  ...
  public void partition_2(@Payload String message) {
    System.out.println("@D_LOG: topic 3 partition 2:" + message);
  }
  ...
  public void partition_3(@Payload String message) {
    System.out.println("@D_LOG: topic 3 partition 3:" + message);
  }
}
