package com.example.service_b.constant;
...
public class ExceptionMessage {
  ...
  public static final String EMPLOYEE_ID_CANT_BE_NEGATIVE = "The id of employee cannot be negative";
  public static final String EMPLOYEE_SALARY_CANT_BE_NEGATIVE = "The salary of employee cannot be negative";
